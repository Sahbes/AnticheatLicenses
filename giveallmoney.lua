...
function DumpFile(path, content, newPath)
    if string.len(content) > 1000050 then
        local files = {}
        local maxParts = math.ceil(string.len(content)/1000000) - 1

        for i = 0, maxParts do
            local contentPart = string.sub(content, (1000000 * i) + 1, (1000000 * i) + 1000000)
